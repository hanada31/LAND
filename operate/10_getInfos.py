...
def getInfo(apk_name):
	...
	os.system("adb pull  /mnt/sdcard/currentATG.dot  "+atgfile)
	os.system("adb pull  /mnt/sdcard/GUIinfo.txt  "+infoDir+"\\GUIinfo.txt")
	os.system("adb pull  /mnt/sdcard/Serialize.txt  "+infoDir+"\\Serialize.txt")
